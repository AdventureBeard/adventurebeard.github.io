...
angular.module('app.controllers')
 ...
 .controller('SinglePostController', ['$scope', '$rootScope', '$routeParams', '$location','$window', 'DataService', function($scope, $rootScope, $routeParams, $location, $window, DataService) {
        ...
        DataService.selectPost($routeParams, function (callback) {
            ...
            $window.document.title = "AdventureBeard | " + $scope.title;
